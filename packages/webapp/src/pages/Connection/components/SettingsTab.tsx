...
export const SettingsTab = () => {
    ...
    const onSaveWebhookUrl = async (webhook_url: string) => {
        try {
                ...
                <div className="w-full flex flex-col gap-10">
                    <div className="flex flex-col gap-2">
                        <div className="flex gap-2 items-center">
                            <FieldLabel htmlFor="webhook_url">Override webhook URL</FieldLabel>
                        ...
                        <EditableInput
                            ...
                            initialValue={connection.connection_config?.webhook_url || ''}
